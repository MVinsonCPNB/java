...
public class Top10Servlet extends HttpServlet {
    ...
    // init runs once when first accessed
    @Override
    ...
    // the doGet runs after init when a user accesses the page SessionMgt/top10
    @Override
