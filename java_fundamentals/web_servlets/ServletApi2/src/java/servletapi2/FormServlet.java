/*
 * Example found on location 874 of 7943
...
public class FormServlet extends HttpServlet {
    ...
    // doGet runs when a user accesses the webpage
    @Override
    public void doGet(HttpServletRequest request,
        ...
        writer.println("</tr>");
        writer.println("<tr>");
        writer.println("<td>Please send me that latest " +
                "product catalog:</td>");
    ...
    // doPost runs when a user posts to the webpage
    @Override
